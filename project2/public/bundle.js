...
var state = {
  ...
  messages: [{
    ...
    sender: "Bao",
    text: "Yeah, still working on this INFO6250 work, but I keep getting distracted by cat videos. Yeah, still working on this INFO6250 work, but I keep getting distracted by cat video"
  }, {
    sender: "Amit",
    text: "You up?"
  }, {
...
function generateMessageListHtml(state) {
  return "<ol class=\"messages\">" + Object.values(state.messages).map(function (message) {
    return "\n      <li>\n        <div class=\"message\">\n          <div class=\"sender-info\">\n            <img class=\"avatar\" alt=\"avatar of ".concat(message.sender, "\" src=\"images/avatar-").concat(message.sender, ".jpg\"/>\n            <span class=\"username\">").concat(message.sender, "</span>\n          </div>\n          <p class=\"message-text\">").concat(message.text, "</p>\n        </div>\n      </li>\n    ");
  }).join('') + "</ol>";
}

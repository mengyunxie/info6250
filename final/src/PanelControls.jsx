...
function PanelControls({username, avatar, menu,labels, avatars, passerbyDiaries, diaries}) {
    ...
    return (
        <div className="panel-controls">
            ...
            {menu === SIDE_MENU.SETTING && <SettingPanel username={username} avatar={avatar} labels={labels} avatars={avatars}/>}
        </div>
    );
}
